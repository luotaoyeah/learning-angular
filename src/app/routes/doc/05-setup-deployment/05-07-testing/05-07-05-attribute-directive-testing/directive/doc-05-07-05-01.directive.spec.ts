...
describe('Doc05070501Directive', () => {
  ...
  beforeEach(async(() => {
    TestBed.configureTestingModule({
      declarations: [TestComponent, Doc05070501Directive],
  ...
  beforeEach(() => {
    ...
    h2DebugElements = fixture.debugElement.queryAll(
       ...
       */
      By.directive(Doc05070501Directive),
    );
    h2DebugElement = fixture.debugElement.query(
      By.css(':not([appDoc05070501])'),
    );
  });
  ...
  it('should have "Doc05070501Directive" in 1st <h2> providerTokens', () => {
    /*
