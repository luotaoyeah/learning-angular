import { Doc0507030101Component } from './doc-05-07-03-01-01.component';

describe('Doc0507030101Component', () => {
  let component: Doc0507030101Component;
  ...
  it('#click() should toggle #isOn', () => {
    component = new Doc0507030101Component();
