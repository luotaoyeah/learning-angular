import { Doc050403Service } from './doc-05-04-03.service';
import { Doc050402Service } from './doc-05-04-02.service';

describe('Doc050403Service', () => {
  let service: Doc050403Service;
  ...
  it('#syncGet() should return a value', () => {
     ...
     */
    service = new Doc050403Service(new Doc050402Service());
  ...
  it('should return a value from a spy', () => {
    const spyObj = jasmine.createSpyObj<Doc050402Service>('Doc050402Service', [
      'syncGet',
    ]);
    spyObj.syncGet.and.returnValue('foo');

    service = new Doc050403Service(spyObj);
