...
import { CONFIG_01, CONFIG_TOKEN_01, CONFIG_TOKEN_02, IConfig } from '@app/views/doc/guide/main-concepts/08-dependency-injection/03-07-03-di-providers/03-07-03-03-value-providers/03-07-03-03-01-non-class-dependencies/doc-03-07-03-03-01-config';
...
export class Doc0307030301Component implements OnInit {
   ...
   */
  constructor(@Inject(CONFIG_TOKEN_01) private config01: IConfig, @Inject(CONFIG_TOKEN_02) private config02: IConfig) {}
