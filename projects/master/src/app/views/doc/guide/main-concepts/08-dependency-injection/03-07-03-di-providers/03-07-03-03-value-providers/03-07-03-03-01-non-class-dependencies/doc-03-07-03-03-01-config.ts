 ...
 */
const CONFIG_TOKEN_01: InjectionToken<IConfig> = new InjectionToken<IConfig>('config.01');

const CONFIG_TOKEN_02: InjectionToken<IConfig> = new InjectionToken<IConfig>('config.02', {
  factory: () => ({
    key: 'FOO',
    value: 'BAZ',
  }),
