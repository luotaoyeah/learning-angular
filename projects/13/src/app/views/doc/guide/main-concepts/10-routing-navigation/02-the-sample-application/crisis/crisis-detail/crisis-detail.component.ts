...
import { ICanDeactivateComponent } from '@app/views/doc/guide/main-concepts/10-routing-navigation/02-the-sample-application/auth/services/can-deactivate.guard';
